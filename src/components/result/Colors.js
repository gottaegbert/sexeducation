...
class Colors extends Component {
    ...
    renderBrownDef() {
        return ( <
            BrownDef title = { 'Brown Type Definition' }
    ...
    renderGreenDef() {
        return ( <
            GreenDef title = { 'Green Type Definition' }
    ...
    renderBlueDef() {
        return ( <
            BlueDef title = { 'Blue Type Definition' }
    ...
    renderRedDef() {
        return ( <
            RedDef title = { 'Red Type Definition' }
    ...
    render() {
        ...
        return ( <
            ...
            <
            h1 className = "display-3 title" > 测试结果 < /h1> <
            hr className = "my-4" / >
            <
            h2 className = "display-6 resultTxt" > 测试显示你拿到了： { this.props.resultColors }
            个福 < /h2> <
            hr className = "my-5" / >
            <
            p className = "lead" > 你能拿到几个福 ? < /p> <
            ul className = "list-group" >
            <
            li className = "list-group-item"
            onClick = { this.onBrownDefClick } >
            Brown <
            div className = "icon" >
            <
